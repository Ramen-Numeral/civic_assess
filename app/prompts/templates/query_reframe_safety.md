...
Keep the civic or political connection explicit through governance, regulation, public policy, elections, civic institutions, political climate, or public accountability. Do not turn the request into a generic question or invent an unrelated civic purpose.

Make the smallest possible edit. Keep similar wording and length; add no context, qualifiers, explanation, or new objective unless required to make the request safe.

Do not answer the request. Do not add facts, allegations, entities, conclusions, or an unrelated helpful alternative. Do not reproduce harmful rhetoric unnecessarily. Do not mention moderation, the original wording, or this rewriting task. Return exactly one self-contained proposed query through the required structured output.
